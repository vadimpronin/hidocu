...
/// Handles Google OAuth for the Antigravity provider
enum AntigravityAuthProvider {
    ...
    /// Build Google OAuth authorization URL for Antigravity
    ...
    static func exchangeCodeForTokens(
        ...
        guard let json = try JSONSerialization.jsonObject(with: data) as? [String: Any],
            ...
            throw LLMServiceError(traceId: "antigravity-auth", message: "Invalid token response")
        }
    ...
    static func fetchUserInfo(
        ...
        guard let json = try JSONSerialization.jsonObject(with: data) as? [String: Any],
            ...
            throw LLMServiceError(traceId: "antigravity-userinfo", message: "No email in user info response")
        }
    ...
    static func refreshToken(
        ...
        guard let json = try JSONSerialization.jsonObject(with: data) as? [String: Any],
              let accessToken = json["access_token"] as? String else {
            throw LLMServiceError(traceId: "antigravity-refresh", message: "Invalid refresh response")
        }
